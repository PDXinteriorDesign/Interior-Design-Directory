...
export const Footer: React.FC = () => {
  ...
  const handleNavigation = (path: string) => {
    ...
    navigate(path);
    // Then scroll to top after a brief delay to ensure navigation is complete
    setTimeout(() => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <button 
                  onClick={() => handleNavigation('/list-with-us')}
                  className="text-white/80 hover:text-azure-400 transition-colors"
                >
                  List Your Business
                </button>
              </li>
              <li>
                <button 
                  onClick={() => handleNavigation('/designers')}
                  className="text-white/80 hover:text-azure-400 transition-colors"
                >
                  Browse Designers
                </button>
